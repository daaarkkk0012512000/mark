...
redis:set(debo.."getidstatus"..msg.chat_id_, "Simple")
...
redis:set(debo..'lock:join:'..msg.chat_id_,true)
...
redis:del(debo..'lock:join:'..msg.chat_id_)
return "*𖤐 ** أهلا عزيزي *"..msg.TheRankCmd.."*\n𖤐 ** تم فتح الدخول بالرابط \n*" 
end


local function idebo(msg,MsgText)

Channel = redis:get(debo..'setch') or katrenno
--JoinChannel
function is_JoinChannel(msg)
if redis:get(debo..'joinchnl') then
...
redis:setex(debo..'ExpireDate:'..msg.chat_id_, extime, true)
if not redis:get(debo..'CheckExpire::'..msg.chat_id_) then 
redis:set(debo..'CheckExpire::'..msg.chat_id_,true) end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️│تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿')
sendMsg(SUDO_ID,0,'💂🏻‍♀️│تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿\n🕵🏼️‍♀️│في مجموعه  » »  '..redis:get(debo..'group:name'..msg.chat_id_))
else
...
if not msg.SudoUser then return "♦️*│*هذا الامر يخص {المطور} فقط  \n💥" end
if MsgText[2] == '1' then
redis:setex(debo..'ExpireDate:'..msg.chat_id_, 2592000, true)
if not redis:get(debo..'CheckExpire::'..msg.chat_id_) then 
redis:set(debo..'CheckExpire::'..msg.chat_id_,true) 
end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️│تم تفعيل الاشتراك   👍🏿\n📆│ الاشتراك » `30 يوم`  *(شهر)*')
sendMsg(SUDO_ID,0,'💂🏻‍♀️│تم تفعيل الاشتراك  👍🏿\n📆│ الاشتراك » `30 يوم`  *(شهر)*')
end
if MsgText[2] == '2' then
redis:setex(debo..'ExpireDate:'..msg.chat_id_,7776000,true)
if not redis:get(debo..'CheckExpire::'..msg.chat_id_) then 
redis:set(debo..'CheckExpire::'..msg.chat_id_,true) 
end
...
if MsgText[2] == '3' then
redis:set(debo..'ExpireDate:'..msg.chat_id_,true)
if not redis:get(debo..'CheckExpire::'..msg.chat_id_) then 
redis:set(debo..'CheckExpire::'..msg.chat_id_,true) end
...
local check_time = redis:ttl(debo..'ExpireDate:'..msg.chat_id_)
...
local GroupName = (redis:get(debo..'group:name'..msg.chat_id_) or '')
redis:set(debo..'linkGroup'..msg.chat_id_,(data.invite_link_ or ""))
...
users = redis:get(debo..'user_names:'..v.user_id_) or v.user_id_
x = x + 1
...
if not msg.Director then return "𖤐 **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local Chek_Info = https.request('https://api.telegram.org/bot'..Token..'/getChatMember?chat_id='.. msg.chat_id_ ..'&user_id='.. debo..'')
...
if not msg.Director and redis:get(debo..'lock_pin'..msg.chat_id_) then
...
function(arg,data)
if data.ID == "Ok" then
redis:set(debo..":MsgIDPin:"..msg.chat_id_,msg.reply_id)
...
if not msg.Admin then return "𖤐 **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
if not MsgText[2] and msg.reply_id then
if redis:get(debo..'lock:kara:'..msg.chat_id_) == 'off' then
...
if redis:get(debo..'lock:kara:'..msg.chat_id_) == 'on' then
...
local Admins = redis:scard(debo..'admins:'..msg.chat_id_)
redis:del(debo..'admins:'..msg.chat_id_)
local NumMDER = redis:scard(debo..'owners:'..msg.chat_id_)
redis:del(debo..'owners:'..msg.chat_id_)
local MMEZEN = redis:scard(debo..'whitelist:'..msg.chat_id_)
redis:del(debo..'whitelist:'..msg.chat_id_)
...
if not msg.Director then return "𖤐 **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if not redis:get(debo..'ExCmdLink'..msg.chat_id_) then
local LinkGp = ExportLink(msg.chat_id_)
if LinkGp then
LinkGp = LinkGp.result
redis:set(debo..'linkGroup'..msg.chat_id_,LinkGp)
redis:setex(debo..'ExCmdLink'..msg.chat_id_,120,true)
...
if not msg.Director then return "𖤐 **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:setex(debo..'linkGroup'..msg.sender_user_id_,300,true)
return '𖤐 عزيزي قم برسال الرابط الجديد ...🍂'
end

if MsgText[1] == "الرابط" then
if not redis:get(debo..'linkGroup'..msg.chat_id_) then 
return "𖤐 ** اوه لا يوجد رابط .\n𖤐 **لانشاء رابط ارسل { `انشاء رابط` }\n" 
end
local GroupName = redis:get(debo..'group:name'..msg.chat_id_)
local GroupLink = redis:get(debo..'linkGroup'..msg.chat_id_)
...
local Text = "𖤐 رابـط الـمـجـمـوعه 𖤐 \n"..Flter_Markdown(redis:get(debo..'group:name'..msg.chat_id_)).." :\n\n["..GroupLink.."]\n"
...
if not msg.Admin then return "𖤐 **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
redis:setex(debo..'rulse:witting'..msg.sender_user_id_,300,true)
return '𖤐 حسننا عزيزي  .\n𖤐 الان ارسل القوانين  للمجموعه .'
end

if MsgText[1] == "القوانين" then
if not redis:get(debo..'rulse:msg'..msg.chat_id_) then 
...
return "*𖤐 القوانين :*\n"..redis:get(debo..'rulse:msg'..msg.chat_id_) 
end 
end
...
redis:set(debo..'flood'..msg.chat_id_,MsgText[2]) 
...
if not msg.Director then return "𖤐 **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local Mn3Word = redis:scard(debo..':Filter_Word:'..msg.chat_id_)
if Mn3Word == 0 then 
return "𖤐 ** عذراً لا توجد كلمات ممنوعه ليتم حذفها" 
end
redis:del(debo..':Filter_Word:'..msg.chat_id_)
...
redis:del(debo..'rulse:msg'..msg.chat_id_)
...
if not msg.Director then return "𖤐 **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if not redis:get(debo..'welcome:msg'..msg.chat_id_) then 
return "𖤐 ** اوه هنالك خطأ .\n𖤐 عذراً لا يوجد ترحيب ليتم مسحه ." 
end
redis:del(debo..'welcome:msg'..msg.chat_id_)
...
local NumMnsha = redis:scard(debo..':Hussain:'..msg.chat_id_)
if NumMnsha ==0 then 
return "𖤐 عذراً لا يوجد منشى اساسي \n!" 
end
redis:del(debo..':Hussain:'..msg.chat_id_)
...
if not msg.SudoUser then return "𖤐 **هذا الامر يخص {المطور} فقط  \n" end
local NumMnsha = redis:scard(debo..':MONSHA_BOT:'..msg.chat_id_)
if NumMnsha ==0 then 
return "𖤐 عذراً لا يوجد منشئيين ليتم مسحهم \n!" 
end
redis:del(debo..':MONSHA_BOT:'..msg.chat_id_)
...
redis:del(debo..'linkGroup'..msg.chat_id_)
...
if not msg.Creator then return "𖤐 **هذا الامر يخص {المطور,المنشئ} فقط  \n" end
redis:setex(debo..'name:witting'..msg.sender_user_id_,300,true)
...
redis:setex(debo..'photo:group'..msg.chat_id_..msg.sender_user_id_,300,true)
...
if not msg.Creator then return "𖤐 **هذا الامر يخص {المطور,المنشئ} فقط  \n" end
redis:setex(debo..'about:witting'..msg.sender_user_id_,300,true) 
...
kick_user(v.user_id_,msg.chat_id_,function(arg,data)  
redis:srem(debo..':MONSHA_BOT:'..msg.chat_id_,v.user_id_)
redis:srem(debo..'whitelist:'..msg.chat_id_,v.user_id_)
redis:srem(debo..'owners:'..msg.chat_id_,v.user_id_)
redis:srem(debo..'admins:'..msg.chat_id_,v.user_id_)
end)
end
NumMem = NumMem + 1
...
if redis:get(debo..'lock_id'..msg.chat_id_) then 
local msgs = redis:get(debo..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 1
GetUserID(msg.sender_user_id_,function(arg,data)
if data.username_ then UserNameID = "@"..data.username_.."" else UserNameID = "" end
local points = redis:get(debo..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
if points and points ~= "0" then
nko = points
else
nko = '0'
end
local rfih = (redis:get(debo..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local NumGha = (redis:get(debo..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local Namei = FlterName(data.first_name_..' '..(data.last_name_ or ""),20)
GetPhotoUser(msg.sender_user_id_,function(arg, data)
if redis:get(debo.."getidstatus"..msg.chat_id_) == "Photo" then
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:get(debo..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:get(debo..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:get(debo..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:get(debo..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:get(debo..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:get(debo..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:get(debo..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:get(debo..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:get(debo..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
redis:del(debo..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
return "𖤐 **تم مسح {* "..msgs.." *} من رسائلك .\n"
end

if MsgText[1]== 'جهاتي' then
return '𖤐 **  عدد جهاتك المضافة‏‏ ⇜ ❪ '..(redis:get(debo..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n.'
end

if MsgText[1] == 'مسح' and MsgText[2] == 'جهاتي'  then
local adduser = redis:get(debo..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0
if adduser == 0 then  return "𖤐 **عذرا ليس لديك جهات لكي يتم مسحها" end
redis:del(debo..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) 
...
local points = redis:get(debo..':User_Points:'..msg.chat_id_..msg.sender_user_id_) or 0
if points == 0 then  return "𖤐 **عذرا ليس لديك نقاط لكِ يتم مسحها" end
redis:del(debo..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:del(debo..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:del(debo..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:del(debo..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:del(debo..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:del(debo..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:del(debo..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:del(debo..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:del(debo..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:del(debo..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
if not msg.Admin then return "𖤐 **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
redis:set(debo..'welcom:witting'..msg.sender_user_id_,true) 
...
if not msg.Admin then return "𖤐 **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
if redis:get(debo..'welcome:msg'..msg.chat_id_)  then
return Flter_Markdown(redis:get(debo..'welcome:msg'..msg.chat_id_))
else 
return "𖤐 **أهلا عزيزي "..msg.TheRankCmd.."  \n𖤐 نورت المجموعه \n" 
end 
end
...
local groups = redis:smembers(debo..'group:ids')
...
local pv = redis:smembers(debo..'users')
local NumPvDel = 0
for i = 1, #pv do
...
redis:setex(debo..'welcom_ph:witting'..msg.sender_user_id_,300,true) 
...
local Photo_Weloame = redis:get(debo..':WELCOME_BOT')
if Photo_Weloame then
sendPhoto(msg.chat_id_,msg.id_,Photo_Weloame,[[𖤐 اهلا انا بوت]]..redis:get(debo..':NameBot:')..[[ .
...
redis:setex(debo..'text_sudo:witting'..msg.sender_user_id_,1200,true) 
return '𖤐 حسننا عزيزي .\n𖤐 الان قم بارسال الكليشه \n' 
end

if MsgText[1] == "ضع شرط التفعيل" and MsgText[2] and MsgText[2]:match('^%d+$') then 
redis:set(debo..':addnumberusers',MsgText[2]) 
return '𖤐 ** تم وضـع شـرط التفعيل البوت اذا كانت المجموعه‏‏ اكثر مـن *【'..MsgText[2]..'】* عضـو  .\n' 
end

if MsgText[1] == "شرط التفعيل" then 
return'𖤐 ** شـرط التفعيل البوت اذا كانت المجموعه‏‏ اكثر مـن *【'..redis:get(debo..':addnumberusers')..'】* عضـو .\n' 
end 
end

if MsgText[1] == 'المجموعات' or MsgText[1] == "المجموعات 🌋" then
if not msg.SudoUser then return "𖤐 **هذا الامر يخص {المطور} فقط  \n" end
return '𖤐 ** عدد المجموعات المفعلة » `'..redis:scard(debo..'group:ids')..'`  ➼' 
end

if MsgText[1] == "المشتركين" or MsgText[1] == "المشتركين Ⓜ" then
if not msg.SudoUser then return "𖤐 **هذا الامر يخص {المطور} فقط  \n" end
return '𖤐 **عدد المشتركين في البوت : `'..redis:scard(debo..'users')..'` \n'
end
...
if not msg.SudoUser then return "𖤐 **هذا الامر يخص {المطور} فقط  \n" end
if redis:sismember(debo..'group:ids',MsgText[2]) then
local name_gp = redis:get(debo..'group:name'..MsgText[2])
...
return redis:get(debo..":TEXT_SUDO") or '𖤐 لا توجد كليشه المطور .\n𖤐 يمكنك اضافه كليشه من خلال الامر\n       " `ضع كليشه المطور` " \n'
end

if MsgText[1] == "اذاعه عام بالتوجيه" or MsgText[1] == "اذاعه عام بالتوجيه 📣" then
if not msg.SudoUser then return"𖤐 **هذا الامر يخص {المطور} فقط  \n" end
if not msg.SudoBase and not redis:get(debo..'lock_brod') then 
return "𖤐 ** الاذاعه مقفوله من قبل المطور الاساسي  ." 
end
redis:setex(debo..'fwd:'..msg.sender_user_id_,300, true) 
...
redis:setex(debo..'fwd:all'..msg.sender_user_id_,300, true) 
...
redis:setex(debo..'fwd:pv'..msg.sender_user_id_,300, true) 
...
redis:setex(debo..'fwd:groups'..msg.sender_user_id_,300, true) 
...
if not msg.Admin then return "𖤐 **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
redis:del(debo..'welcom:witting'..msg.sender_user_id_,
debo..'rulse:witting'..msg.sender_user_id_,
debo..'rulse:witting'..msg.sender_user_id_,
debo..'name:witting'..msg.sender_user_id_,
debo..'about:witting'..msg.sender_user_id_,
debo..'fwd:all'..msg.sender_user_id_,
debo..'fwd:pv'..msg.sender_user_id_,
debo..'fwd:groups'..msg.sender_user_id_,
debo..'namebot:witting'..msg.sender_user_id_,
debo..'addrd_all:'..msg.sender_user_id_,
debo..'delrd:'..msg.sender_user_id_,
debo..'addrd:'..msg.sender_user_id_,
debo..'delrdall:'..msg.sender_user_id_,
debo..'text_sudo:witting'..msg.sender_user_id_,
debo..'addrd:'..msg.chat_id_..msg.sender_user_id_,
debo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
redis:set(debo..":VERSION",GetVerison)
return false
else
...
local inline = {{{text="-قنآهہ‏‏ آلسـورس اضـغـط هـنـآ ",url="https://t.me/DEBO_TEAM_3"}}}
send_key(msg.sender_user_id_,'   [قناة سورس : DEBO_TEAM_3](https://t.me/DEBO_TEAM_3)' ,nil,inline,msg.id_)
return false
end

 MsgText[1]== "رفع نسخه الاحتياطيه" and msg.type == "pv" then
...
if MsgText[1]== "المالك ديبو" and msg.type == "pv" then
local inline = {{{text="-مالك السورس اضـغـط هـنـآ ",url="https://t.me/QpSSpQ"}}}
send_key(msg.sender_user_id_,'   [المالك ديبو](https://t.me/QpSSpQ)' ,nil,inline,msg.id_)
return false
end
...
if not msg.SudoBase then return"𖤐 **هذا الامر يخص {المطور الاساسي} فقط  \n" end
return '𖤐 الاحصائيات . \n\n𖤐 **عدد المجموعات المفعله : '..redis:scard(debo..'group:ids')..'\n𖤐 **عدد المشتركين في البوت : '..redis:scard(debo..'users')..'\n'
end
---------------[End Function data] -----------------------
if MsgText[1]=="اضف رد عام" or MsgText[1]=="اضف رد عام ➕" then
if not msg.SudoBase then return"𖤐 **هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:setex(debo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_,300,true)
redis:del(debo..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
...
if not msg.Director then return "𖤐 **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local names 	= redis:exists(debo..'replay:'..msg.chat_id_)
local photo 	= redis:exists(debo..'replay_photo:group:'..msg.chat_id_)
local voice 	= redis:exists(debo..'replay_voice:group:'..msg.chat_id_)
local imation   = redis:exists(debo..'replay_animation:group:'..msg.chat_id_)
local audio	 	= redis:exists(debo..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:exists(debo..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:exists(debo..'replay_video:group:'..msg.chat_id_)
if names or photo or voice or imation or audio or sticker or video then
redis:del(debo..'replay:'..msg.chat_id_,debo..'replay_photo:group:'..msg.chat_id_,debo..'replay_voice:group:'..msg.chat_id_,
debo..'replay_animation:group:'..msg.chat_id_,debo..'replay_audio:group:'..msg.chat_id_,debo..'replay_sticker:group:'..msg.chat_id_,debo..'replay_video:group:'..msg.chat_id_)
...
local names 	= redis:exists(debo..'replay:all')
local photo 	= redis:exists(debo..'replay_photo:group:')
local voice 	= redis:exists(debo..'replay_voice:group:')
local imation 	= redis:exists(debo..'replay_animation:group:')
local audio 	= redis:exists(debo..'replay_audio:group:')
local sticker 	= redis:exists(debo..'replay_sticker:group:')
local video 	= redis:exists(debo..'replay_video:group:')
if names or photo or voice or imation or audio or sticker or video then
redis:del(debo..'replay:all',debo..'replay_photo:group:',debo..'replay_voice:group:',debo..'replay_animation:group:',debo..'replay_audio:group:',debo..'replay_sticker:group:',debo..'replay_video:group:')
...
if not msg.SudoBase then return"𖤐 **هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:set(debo..'delrdall:'..msg.sender_user_id_,true) 
return "𖤐 حسننا عزيزي  .\n𖤐 الان ارسل الرد لمسحها من  المجموعات ."
end

if MsgText[1]== 'مسح' and MsgText[2]== 'رد' then
if not msg.Director then return "𖤐 **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:set(debo..'delrd:'..msg.sender_user_id_,true)
return "𖤐 حسننا عزيزي  .\n𖤐 الان ارسل الرد لمسحها من  للمجموعه ."
end

if MsgText[1]== 'الردود' then
if not msg.Director then return "𖤐 *│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local names  	= redis:hkeys(debo..'replay:'..msg.chat_id_)
local photo 	= redis:hkeys(debo..'replay_photo:group:'..msg.chat_id_)
local voice  	= redis:hkeys(debo..'replay_voice:group:'..msg.chat_id_)
local imation 	= redis:hkeys(debo..'replay_animation:group:'..msg.chat_id_)
local audio 	= redis:hkeys(debo..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:hkeys(debo..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:hkeys(debo..'replay_video:group:'..msg.chat_id_)
...
local names 	= redis:hkeys(debo..'replay:all')
local photo 	= redis:hkeys(debo..'replay_photo:group:')
local voice 	= redis:hkeys(debo..'replay_voice:group:')
local imation 	= redis:hkeys(debo..'replay_animation:group:')
local audio 	= redis:hkeys(debo..'replay_audio:group:')
local sticker 	= redis:hkeys(debo..'replay_sticker:group:')
local video 	= redis:hkeys(debo..'replay_video:group:')
if #names==0 and #photo==0 and #voice==0 and #imation==0 and #audio==0 and #sticker==0 and #video==0 then 
return '𖤐 **لا يوجد ردود مضافه حاليا \n' 
end
local ii = 1
...
if not msg.Director then return "𖤐 **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:setex(debo..'addrd:'..msg.chat_id_..msg.sender_user_id_,300,true) 
redis:del(debo..'replay1'..msg.chat_id_..msg.sender_user_id_)
return "𖤐 حسننا , الان ارسل كلمه الرد \n"
end

if MsgText[1] == "ضع اسم للبوت" or MsgText[1]== 'ضع اسم للبوت ©' then
if not msg.SudoBase then return"𖤐 **هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:setex(debo..'namebot:witting'..msg.sender_user_id_,300,true)
...
if not msg.Admin then return "𖤐 **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n𖤐 " end
if not redis:get(debo..'lave_me'..msg.chat_id_) then 
return "𖤐 **أهلا عزيزي "..msg.TheRankCmd.."\n𖤐 ** المغادره بالتاكيد تم تفعيلها\n✓" 
else 
redis:del(debo..'lave_me'..msg.chat_id_) 
return "𖤐 **أهلا عزيزي "..msg.TheRankCmd.."\n𖤐 ** تم تفعيل المغادره \n✓" 
end 
end
if MsgText[1] == "تعطيل" and MsgText[2] == "اطردني" then
if not msg.Admin then return "𖤐 **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n𖤐 " end
if redis:get(debo..'lave_me'..msg.chat_id_) then 
return "𖤐 **أهلا عزيزي "..msg.TheRankCmd.."\n𖤐 ** المغادره من قبل البوت بالتأكيد معطله\n✓" 
else
redis:set(debo..'lave_me'..msg.chat_id_,true)  
...
[𝘥𝘦𝘷𝘦𝘭𝘰𝘱𝘦𝘳](https://t.me/A_j_o_k_e_r)

 [𝘥𝘦𝘷𝘦𝘭𝘰𝘱𝘦𝘳](https://t.me/QpSSpQ)

[𝘤𝘰𝘮𝘮𝘶𝘯𝘪𝘤𝘢𝘵𝘪𝘰𝘯 𝄬](https://t.me/RISK_00)
]]
end
...
if not msg.SudoBase then return"𖤐 **هذا الامر يخص {المطور الاساسي} فقط  \n" end
local SubDel = redis:del(debo..":UserNameChaneel")
if SubDel == 1 then
...
if not msg.SudoBase then return"𖤐 **هذا الامر يخص {المطور الاساسي} فقط  \n" end
local UserChaneel = redis:get(debo..":UserNameChaneel")
if UserChaneel then
...
if redis:get(debo..'welc'..msg.chat_id_) == 'on' then
...
local hash = debo..'user_names:'..msg.sender_user_id_
redis:set(hash,info)
end
...
mmd = redis:get(debo..'addcmd'..msg.chat_id_..msg.sender_user_id_)
if mmd then
redis:sadd(debo..'CmDlist:'..msg.chat_id_,msg.text)
redis:hset(debo..'CmD:'..msg.chat_id_,msg.text,mmd)
sendMsg(msg.chat_id_,msg.id_,'𖤐 اهلا عزيزي \n𖤐 تم تثبيت الامر الجديد\n✓')
redis:del(debo..'addcmd'..msg.chat_id_..msg.sender_user_id_)
end

if Black:match('تغير امر (.*)') then
if not msg.Kara then return "𖤐 **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
local cmd = Black:match('تغير امر (.*)') 
redis:setex(debo..'addcmd'..msg.chat_id_..msg.sender_user_id_,120,cmd)
...
redis:hdel(debo..'CmD:'..msg.chat_id_,cmd)
redis:srem(debo..'CmDlist:'..msg.chat_id_,cmd)
sendMsg(msg.chat_id_,msg.id_,"𖤐 اهلا عزيزي\nالامر >"..cmd.."\n𖤐 تم مسحه من قائمه الاوامر\n")
end
if Black == 'مسح قائمه الاوامر' or Black == 'مسح قائمه الاوامر' then
if not msg.Kara then return "𖤐 **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
redis:del(debo..'CmD:'..msg.chat_id_)
redis:del(debo..'CmDlist:'..msg.chat_id_)
sendMsg(msg.chat_id_,msg.id_,"𖤐 اهلا عزيزي تم مسح قائمه الاوامر")
end
if Black == "قائمه الاوامر" then
if not msg.Kara then return "𖤐 **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
local CmDlist = redis:smembers(debo..'CmDlist:'..msg.chat_id_)
local t = '𖤐 قائمه الاوامر : \n'
for k,v in pairs(CmDlist) do
mmdi = redis:hget(debo..'CmD:'..msg.chat_id_,v)
t = t..k..") "..v.." > "..mmdi.."\n" 
end
if #CmDlist == 0 then
...
redis:set(debo..'welc'..msg.chat_id_,'on')
end
end
if Text == 'welcome off' or Text == 'تعطيل الترحيب' then
if redis:get(debo..'welc'..msg.chat_id_) == 'off' then
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل الترحيب سابقا')
redis:set(debo..'welc'..msg.chat_id_,'off')
redis:del(debo..'welc'..msg.chat_id_,'on')
else
...
function tophoto(kara,debo)   
if debo.content_.ID == "MessageSticker" then        
local bd = debo.content_.sticker_.sticker_.path_          
...
local msg_pv = tonumber(redis:get(debo..'user:'..msg.sender_user_id_..':msgs') or 0)
if msg_pv > 5 then
redis:setex(debo..':mute_pv:'..msg.sender_user_id_,18000,true)   
return sendMsg(msg.chat_id_,0,'*𖤐 * تم حظرك من البوت بسبب التكرار \n') 
end
redis:setex(debo..'user:'..msg.sender_user_id_..':msgs',2,msg_pv+1)
end
...
redis:sadd(debo..'users',msg.sender_user_id_)
if redis:get(debo..'lock_service') then 
text = [[𖤐 أهلاً انا بوت   []]..redis:get(debo..':NameBot:')..[[] 🗽
...
local MSG_ID = (redis:get(debo.."USER_MSG_TWASEL"..FwdDate) or 1)
if msg.text then
...
if not redis:get(debo..'lock_twasel') then
...
redis:setex(debo.."USER_MSG_TWASEL"..msg.date_,43200,msg.id_)
...
--====================== Reply Only Group ====================================
if redis:get(debo..'addrd:'..msg.chat_id_..msg.sender_user_id_) and redis:get(debo..'replay1'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(debo..'replay1'..msg.chat_id_..msg.sender_user_id_)
if msg.text then 
redis:hset(debo..'replay:'..msg.chat_id_,klma,Flter_Markdown(msg.text))
redis:del(debo..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'(['..klma..'])\n𖤐 تم اضافت الرد . \n-')
elseif msg.photo then 
redis:hset(debo..'replay_photo:group:'..msg.chat_id_,klma,photo_id)
redis:del(debo..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'𖤐 تم اضافه صوره للرد بنجاح\n𖤐 يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.voice then
redis:hset(debo..'replay_voice:group:'..msg.chat_id_,klma,voice_id)
redis:del(debo..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'𖤐 تم اضافه بصمه صوت للرد بنجاح\n𖤐 يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(debo..'replay_animation:group:'..msg.chat_id_,klma,animation_id)
redis:del(debo..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'𖤐 تم اضافه متحركه للرد بنجاح\n𖤐 يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.video then
redis:hset(debo..'replay_video:group:'..msg.chat_id_,klma,video_id)
redis:del(debo..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'𖤐 تم اضافه فيديو للرد بنجاح\n𖤐 يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(debo..'replay_audio:group:'..msg.chat_id_,klma,audio_id)
redis:del(debo..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'𖤐 تم اضافه للصوت للرد بنجاح\n𖤐 يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(debo..'replay_sticker:group:'..msg.chat_id_,klma,sticker_id)
redis:del(debo..'addrd:'..msg.chat_id_..msg.sender_user_id_)
...
--====================== Reply All Groups =====================================
if redis:get(debo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) and redis:get(debo..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(debo..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
if msg.text then
redis:hset(debo..'replay:all',klma,Flter_Markdown(msg.text))
redis:del(debo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'(['..klma..'])\n  𖤐 تم اضافت الرد لكل المجموعات . ')
elseif msg.photo then 
redis:hset(debo..'replay_photo:group:',klma,photo_id)
redis:del(debo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'𖤐 تم اضافه صوره للرد العام\n𖤐 يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.voice then
redis:hset(debo..'replay_voice:group:',klma,voice_id)
redis:del(debo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'𖤐 تم اضافه بصمه صوت للرد العام\n𖤐 يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(debo..'replay_animation:group:',klma,animation_id)
redis:del(debo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'𖤐 تم اضافه متحركه للرد العام\n𖤐 يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.video then
redis:hset(debo..'replay_video:group:',klma,video_id)
redis:del(debo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'𖤐 تم اضافه فيديو للرد العام\n𖤐 يمكنك ارسال ❴ ['..klma..'] ❵لأظهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(debo..'replay_audio:group:',klma,audio_id)
redis:del(debo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'𖤐 تم اضافه للصوت للرد العام\n𖤐 يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(debo..'replay_sticker:group:',klma,sticker_id)
redis:del(debo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
if redis:get(debo..":ForceSub:"..msg.sender_user_id_) then
if msg.text:match("^@[%a%d_]+$") then
redis:del(debo..":ForceSub:"..msg.sender_user_id_)
...
redis:set(debo..":UserNameChaneel",msg.text)
...
if redis:get(debo..'namebot:witting'..msg.sender_user_id_) then --- استقبال اسم البوت 
redis:del(debo..'namebot:witting'..msg.sender_user_id_)
redis:set(debo..':NameBot:',msg.text)
Start_Bot() 
sendMsg(msg.chat_id_,msg.id_,"𖤐 تم تغير اسم البوت  .\n𖤐 الان اسمه "..Flter_Markdown(msg.text).." \n")
return false
end

if redis:get(debo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد لكل المجموعات
if not redis:get(debo..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال كلمه الرد لكل المجموعات
redis:hdel(debo..'replay_photo:group:',msg.text)
redis:hdel(debo..'replay_voice:group:',msg.text)
redis:hdel(debo..'replay_animation:group:',msg.text)
redis:hdel(debo..'replay_audio:group:',msg.text)
redis:hdel(debo..'replay_sticker:group:',msg.text)
redis:hdel(debo..'replay_video:group:',msg.text)
redis:setex(debo..'allreplay:'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"𖤐 جيد , يمكنك الان ارسال جوا ب الردالعام \n𖤐 [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]\n")
end
end

if redis:get(debo..'delrdall:'..msg.sender_user_id_) then
redis:del(debo..'delrdall:'..msg.sender_user_id_)
local names = redis:hget(debo..'replay:all',msg.text)
local photo =redis:hget(debo..'replay_photo:group:',msg.text)
local voice = redis:hget(debo..'replay_voice:group:',msg.text)
local animation = redis:hget(debo..'replay_animation:group:',msg.text)
local audio = redis:hget(debo..'replay_audio:group:',msg.text)
local sticker = redis:hget(debo..'replay_sticker:group:',msg.text)
local video = redis:hget(debo..'replay_video:group:',msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'𖤐 **هذا الرد ليس مضاف في قائمه الردود .')
else
redis:hdel(debo..'replay:all',msg.text)
redis:hdel(debo..'replay_photo:group:',msg.text)
redis:hdel(debo..'replay_voice:group:',msg.text)
redis:hdel(debo..'replay_audio:group:',msg.text)
redis:hdel(debo..'replay_animation:group:',msg.text)
...
if redis:get(debo..'text_sudo:witting'..msg.sender_user_id_) then -- استقبال كليشه المطور
redis:del(debo..'text_sudo:witting'..msg.sender_user_id_) 
redis:set(debo..':TEXT_SUDO',Flter_Markdown(msg.text))
return sendMsg(msg.chat_id_,msg.id_, "𖤐 ** تم وضع الكليشه بنجاح كلاتي .\n\n*{*  "..Flter_Markdown(msg.text).."  *}*\n")
end
if redis:get(debo..'welcom:witting'..msg.sender_user_id_) then -- استقبال كليشه الترحيب
redis:del(debo..'welcom:witting'..msg.sender_user_id_) 
redis:set(debo..'welcome:msg'..msg.chat_id_,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"𖤐 ** تم وضع الترحيب بنجاح كلاتي .\n" )
end
if redis:get(debo..'rulse:witting'..msg.sender_user_id_) then --- استقبال القوانين
redis:del(debo..'rulse:witting'..msg.sender_user_id_) 
redis:set(debo..'rulse:msg'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'𖤐 ** مرحبآ عزيزي\n𖤐 تم حفظ القوانين بنجاح .\n𖤐 ارسل [[ القوانين ]] لعرضها \n')
end
if redis:get(debo..'name:witting'..msg.sender_user_id_) then --- استقبال الاسم
redis:del(debo..'name:witting'..msg.sender_user_id_) 
tdcli_function({ID= "ChangeChatTitle",chat_id_=msg.chat_id_,title_=msg.text},dl_cb,nil)
end
if redis:get(debo..'linkGroup'..msg.sender_user_id_,link) then --- استقبال الرابط
redis:del(debo..'linkGroup'..msg.sender_user_id_,link) 
redis:set(debo..'linkGroup'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'𖤐 تم وضع الرابط الجديد بنجاح .. 🍂')
end
if redis:get(debo..'about:witting'..msg.sender_user_id_) then --- استقبال الوصف
redis:del(debo..'about:witting'..msg.sender_user_id_) 
...
if redis:get(debo..'fwd:all'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه عام
redis:del(debo..'fwd:all'..msg.sender_user_id_)
local pv = redis:smembers(debo..'users')  
local groups = redis:smembers(debo..'group:ids')
...
if redis:get(debo..'fwd:pv'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(debo..'fwd:pv'..msg.sender_user_id_)
local pv = redis:smembers(debo..'users')
if #pv >= 300 then
...
if redis:get(debo..'fwd:groups'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(debo..'fwd:groups'..msg.sender_user_id_)
local groups = redis:smembers(debo..'group:ids')
if #groups >= 300 then
...
if msg.adduser and msg.adduser == our_id and redis:get(debo..':WELCOME_BOT') then
sendPhoto(msg.chat_id_,msg.id_,redis:get(debo..':WELCOME_BOT'),[[𖤐أهلاً انا بوت ]]..redis:get(debo..':NameBot:')..[[
𖤐 أختصاصي حماية‌‏ المجموعات
𖤐 مـن السبام والتوجيه‌‏ والتكرار والخ...
...
if msg.forward_info and redis:get(debo..'fwd:'..msg.sender_user_id_) then
redis:del(debo..'fwd:'..msg.sender_user_id_)
local pv = redis:smembers(debo..'users')
local groups = redis:smembers(debo..'group:ids')
local allgp =  #pv + #groups
if allgp == 500 then
...
if msg.content_.ID == "MessagePhoto" and redis:get(debo..'welcom_ph:witting'..msg.sender_user_id_) then
redis:del(debo..'welcom_ph:witting'..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
end
redis:set(debo..':WELCOME_BOT',photo_id)
return sendMsg(msg.chat_id_,msg.id_,'𖤐 تم تغيير صوره‏‏ الترحيب للبوت .\n')
end 

if msg.content_.ID == "MessagePhoto" and msg.type == "channel" and msg.GroupActive then
if redis:get(debo..'photo:group'..msg.chat_id_..msg.sender_user_id_) then
redis:del(debo..'photo:group'..msg.chat_id_..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
if redis:get(debo..'addrd:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد للمجموعه فقط

if not redis:get(debo..'replay1'..msg.chat_id_..msg.sender_user_id_) then  -- كلمه الرد
redis:hdel(debo..'replay:'..msg.chat_id_,msg.text)
redis:hdel(debo..'replay_photo:group:'..msg.chat_id_,msg.text)
redis:hdel(debo..'replay_voice:group:'..msg.chat_id_,msg.text)
redis:hdel(debo..'replay_animation:group:'..msg.chat_id_,msg.text)
redis:hdel(debo..'replay_audio:group:'..msg.chat_id_,msg.text)
redis:hdel(debo..'replay_sticker:group:'..msg.chat_id_,msg.text)
redis:hdel(debo..'replay_video:group:'..msg.chat_id_,msg.text)
redis:setex(debo..'replay1'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"𖤐 جيد , يمكنك الان ارسال جواب الرد \n𖤐 [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]\n")
end
end

if redis:get(debo..'delrd:'..msg.sender_user_id_) then
redis:del(debo..'delrd:'..msg.sender_user_id_)
local names 	= redis:hget(debo..'replay:'..msg.chat_id_,msg.text)
local photo 	= redis:hget(debo..'replay_photo:group:'..msg.chat_id_,msg.text)
local voice 	= redis:hget(debo..'replay_voice:group:'..msg.chat_id_,msg.text)
local animation = redis:hget(debo..'replay_animation:group:'..msg.chat_id_,msg.text)
local audio 	= redis:hget(debo..'replay_audio:group:'..msg.chat_id_,msg.text)
local sticker 	= redis:hget(debo..'replay_sticker:group:'..msg.chat_id_,msg.text)
local video 	= redis:hget(debo..'replay_video:group:'..msg.chat_id_,msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'𖤐 **هذا الرد ليس مضاف في قائمه الردود .')
else
redis:hdel(debo..'replay:'..msg.chat_id_,msg.text)
...
if msg.pinned then
print(" -- pinned -- ")
local msg_pin_id = redis:get(debo..":MsgIDPin:"..msg.chat_id_)
if not msg.Director and redis:get(debo..'lock_pin'..msg.chat_id_) then
if msg_pin_id then
...
redis:set(debo..":MsgIDPin:"..msg.chat_id_,msg.id_)
end
...
GetUserID(msg.sender_user_id_,function(arg,data)
redis:set(debo..'group:name'..msg.chat_id_,msg.content_.title_)
if data.username_ then UserName = "@"..data.username_ else UserName = "احد المشرفين" end
...
if redis:get(debo..'mute_tgservice'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_)
else
if redis:get(debo..'welcome:get'..msg.chat_id_) then 
if not msg.adduserType then
GetUserID(msg.sender_user_id_,function(arg,data)  
welcome = (redis:get(debo..'welcome:msg'..msg.chat_id_) or "𖤐 اهلاً عزيزي {الاسم}\n𖤐 معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n𖤐 اسم القروب » {المجموعه}")
if welcome then
rules = (redis:get(debo..'rulse:msg'..msg.chat_id_) or "𖤐 مرحباً عزيري القوانين كلاتي .\n𖤐 ممنوع نشر الروابط\n𖤐 ممنوع التكلم او نشر صور اباحيه\n𖤐 ممنوع  اعاده توجيه\n𖤐 ممنوع التكلم بالسياسة\n𖤐 الرجاء احترام المدراء والادمنيه .\n")
welcome = welcome:gsub("{القوانين}", rules)
if data.username_ then UserName = '@'..data.username_ else UserName = '< لا يوجد معرف >' end
welcome = welcome:gsub("{المجموعه}",Flter_Markdown((redis:get(debo..'group:name'..msg.chat_id_) or '')))
...
welcome = (redis:get(debo..'welcome:msg'..msg.chat_id_) or "𖤐 اهلن بك عزيزي {الاسم}\n𖤐 معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n𖤐 اسم القروب » {المجموعه}")
if welcome then
rules = (redis:get(debo..'rulse:msg'..msg.chat_id_) or "𖤐 مرحباً عزيري القوانين كلاتي .\n𖤐 ممنوع نشر الروابط\n𖤐 ممنوع التكلم او نشر صور اباحيه\n𖤐 ممنوع  اعاده توجيه\n𖤐 ممنوع التكلم بالسياسة\n𖤐 الرجاء احترام المدراء والادمنيه\n")
welcome = welcome:gsub("{القوانين}", rules)
...
--------------------------------------------
if msg.adduser and redis:get(debo..'welcome:get'..msg.chat_id_) then
local adduserx = tonumber(redis:get(debo..'user:'..msg.sender_user_id_..':msgs') or 0)
if adduserx > 3 then 
redis:del(debo..'welcome:get'..msg.chat_id_)
end
redis:setex(debo..'user:'..msg.sender_user_id_..':msgs',3,adduserx+1)
end

if not msg.Admin and not msg.Special and not (msg.adduser or msg.joinuser or msg.deluser ) then -- للاعضاء فقط   

if not msg.forward_info and redis:get(debo..'lock_flood'..msg.chat_id_)  then
local msgs = (redis:get(debo..'user:'..msg.sender_user_id_..':msgs') or 0)
local NUM_MSG_debo = (redis:get(debo..'num_msg_debo'..msg.chat_id_) or 5)
if tonumber(msgs) > tonumber(NUM_MSG_debo) then 
GetUserID(msg.sender_user_id_,function(arg,datau)
Restrict(msg.chat_id_,msg.sender_user_id_,1)
redis:setex(debo..'sender:'..msg.sender_user_id_..':flood',30,true)
if datau.username_ then USERNAME = '@'..datau.username_ else USERNAME = FlterName(datau.first_name_..' '..(datau.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
SendMention(msg.chat_id_,datau.id_,msg.id_,"𖤐 العضو » "..USERNAME.."\n𖤐 قمـت بتكرار اكثر مـن "..NUM_MSG_debo.." رسالة‌‏ , لذا تم تقييدك مـن المجموعه‌\n",12,USERCAR) 
return false
end)
end 
redis:setex(debo..'user:'..msg.sender_user_id_..':msgs',2,msgs+1)
end
...
if redis:get(debo..'mute_forward'..msg.chat_id_) then -- قفل التوجيه
...
if redis:get(debo..'lock_woring'..msg.chat_id_) and not redis:get(debo..':User_Fwd_Msg:'..msg.sender_user_id_..':flood') then
GetUserID(msg.sender_user_id_,function(arg,data)
...
return redis:setex(debo..':User_Fwd_Msg:'..msg.sender_user_id_..':flood',15,true)
end,nil)
end
end)
return false
elseif redis:get(debo..':tqeed_fwd:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif tonumber(msg.via_bot_user_id_) ~= 0 and redis:get(debo..'mute_inline'..msg.chat_id_) then -- قفل الانلاين
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
print("\27[1;31m Msg Del becuse send inline \27[0m")
if data.ID == "Error" and data.code_ == 6 then
return sendMsg(msg.chat_id_,msg.id_,'𖤐 ** لا يمكنني مسح الرساله المخالفه .\n𖤐 ** لست مشرف او ليس لدي صلاحيه  الحذف \n')    
end
if redis:get(debo..'lock_woring'..msg.chat_id_) then
GetUserID(msg.sender_user_id_,function(arg,data)
...
if utf8.len(msg.text) > 500 and redis:get(debo..'lock_spam'..msg.chat_id_) then -- قفل الكليشه 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(debo..':tqeed_link:'..msg.chat_id_)  then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(debo..'lock_link'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif (msg.text:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.text:match("[Hh][Tt][Tt][Pp]://") or msg.text:match("[Ww][Ww][Ww].") or msg.text:match(".[Cc][Oo][Mm]") or msg.text:match(".[Tt][Kk]") or msg.text:match(".[Mm][Ll]") or msg.text:match(".[Oo][Rr][Gg]")) and redis:get(debo..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("#[%a%d_]+") and redis:get(debo..'lock_tag'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("@[%a%d_]+")  and redis:get(debo..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif not msg.textEntityTypeBold and (msg.textEntityTypeBold or msg.textEntityTypeItalic) and redis:get(debo..'lock_markdown'..msg.chat_id_) then 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.textEntityTypeTextUrl and redis:get(debo..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.edited and redis:get(debo..'lock_edit'..msg.chat_id_) then -- قفل التعديل
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.content_.ID == "MessageUnsupported" and redis:get(debo..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.photo then
if redis:get(debo..'mute_photo'..msg.chat_id_)  then -- قفل الصور
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(debo..':tqeed_photo:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.video then
if redis:get(debo..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(debo..':tqeed_video:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.document and redis:get(debo..'mute_document'..msg.chat_id_) then -- قفل الملفات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.sticker and redis:get(debo..'mute_sticker'..msg.chat_id_) then --قفل الملصقات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.animation then
if redis:get(debo..'mute_gif'..msg.chat_id_) then -- قفل المتحركه
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(debo..':tqeed_gif:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.contact and redis:get(debo..'mute_contact'..msg.chat_id_) then -- قفل الجهات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.location and redis:get(debo..'mute_location'..msg.chat_id_) then -- قفل الموقع
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.voice and redis:get(debo..'mute_voice'..msg.chat_id_) then -- قفل البصمات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.game and redis:get(debo..'mute_game'..msg.chat_id_) then -- قفل الالعاب
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.audio and redis:get(debo..'mute_audio'..msg.chat_id_) then -- قفل الصوت
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.replyMarkupInlineKeyboard and redis:get(debo..'mute_keyboard'..msg.chat_id_) then -- كيبورد
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(debo..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.caption_:match("@[%a%d_]+") and redis:get(debo..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if msg.text and redis:get(debo..'replay'..msg.chat_id_) then

local Replay = false

 Replay = redis:hget(debo..'replay:all',msg.text)
if Replay then
sendMsg(msg.chat_id_,msg.id_,Replay)
return false
end

 Replay = redis:hget(debo..'replay:'..msg.chat_id_,msg.text)
if Replay then 
 sendMsg(msg.chat_id_,msg.id_,Replay) 
return false
end
 Replay = redis:hget(debo..'replay_photo:group:',msg.text)
if Replay then 
 sendPhoto(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(debo..'replay_voice:group:',msg.text)
if Replay then 
 sendVoice(msg.chat_id_,msg.id_,Replay)
return false
end

Replay = redis:hget(debo..'replay_animation:group:',msg.text)
if Replay then 
 sendAnimation(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(debo..'replay_audio:group:',msg.text)
if Replay then 
 sendAudio(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(debo..'replay_sticker:group:',msg.text)
if Replay then 
 sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(debo..'replay_video:group:',msg.text)
if Replay then 
print("0000000000000") 
...
Replay = redis:hget(debo..'replay_photo:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendPhoto(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(debo..'replay_voice:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendVoice(msg.chat_id_,msg.id_,Replay)
return false
end

Replay = redis:hget(debo..'replay_animation:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendAnimation(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(debo..'replay_audio:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendAudio(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(debo..'replay_sticker:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(debo..'replay_video:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendVideo(msg.chat_id_,msg.id_,Replay)
return false
end
...
elseif Text== "ديبو" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور سورس مارك](https://t.me/QpSSpQ)")
...
elseif Text== "سورس مارك" then return  sendMsg(msg.chat_id_,msg.id_,"[افجر سورس مصري  𖠲](https://t.me/DEBO_TEAM_3)")
...
return sendMsg(msg.chat_id_,msg.id_,"[انت مطوري الغالي ♕](https://t.me/DEBO_TEAM_3) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[انت منشئ المجموعه  تاج راسي♔](https://t.me/DEBO_TEAM_3)")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[انت مدير المجموعه๑](https://t.me/DEBO_TEAM_3)")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"[انت ادمن شد حيلك♘](https://t.me/DEBO_TEAM_3)")
else 
return sendMsg(msg.chat_id_,msg.id_,"[مجرد عضو هنا 𖦹](https://t.me/DEBO_TEAM_3)")
end 
end 
elseif Text== "مين ضافني" or Text== "منو ضافني"  then
if msg.SudoUser then  
return sendMsg(msg.chat_id_,msg.id_,"[انت مكانك كل مكان يا مطور♕](https://t.me/DEBO_TEAM_3) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[انت منشئ المجموعه](https://t.me/DEBO_TEAM_3)")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/DEBO_TEAM_3)")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/DEBO_TEAM_3)")
else 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/DEBO_TEAM_3)")
...
if not redis:get('kar') then
  ...
  json_data = '{"BotID": '..debo..',"UserBot": "'..Bot_User..'","Groups" : {'
  local All_Groups_ID = redis:smembers(debo..'group:ids')
  for key,GroupS in pairs(All_Groups_ID) do
  local NameGroup = (redis:get(debo..'group:name'..GroupS) or '')
  ...
  local admins = redis:smembers(debo..'admins:'..GroupS)
  if #admins ~= 0 then
  json_data =  json_data..',"Admins" : {'
  for key,value in pairs(admins) do
  local info = redis:hgetall(debo..'username:'..value)
  if info then 
  ...
  local creators = redis:smembers(debo..':MONSHA_BOT:'..GroupS)
  if #creators ~= 0 then
  ...
  local creator = redis:smembers(debo..':KARA_BOT:'..GroupS)
  if #creator ~= 0 then
  ...
  local owner = redis:smembers(debo..'owners:'..GroupS)
  if #owner ~= 0 then
  ...
  if redis:get(debo..'CheckExpire::'..msg.chat_id_) then
  local ExpireDate = redis:ttl(debo..'ExpireDate:'..msg.chat_id_)
  if not ExpireDate and not msg.SudoUser then
  rem_data_group(msg.chat_id_)
  sendMsg(SUDO_ID,0,'𖤐 انتهى الاشتراك في احد المجموعات .\n𖤐 المجموعه : '..FlterName(redis:get(debo..'group:name'..msg.chat_id_))..'.\n𖤐 ايدي : '..msg.chat_id_)
  sendMsg(msg.chat_id_,0,'𖤐 انتهى الاشتراك البوت.\n𖤐 سوف اغادر المجموعه فرصه سعيده .\n𖤐 او راسل المطور للتجديد '..SUDO_USER..' 🍃')
  return StatusLeft(msg.chat_id_,our_id)
  else
  local DaysEx = (redis:ttl(debo..'ExpireDate:'..msg.chat_id_) / 86400)
